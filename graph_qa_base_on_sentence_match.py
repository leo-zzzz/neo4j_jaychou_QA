...
class GraphQA:
    ...
    def cypher_match(self, sentence, info):
        ...
        result = []
        for templet, cypher, answer in templet_cypher_pair:  # 计算每个模板与查询语句的相似度
    ...
    def query(self, sentence):
        info = self.parse_sentence(sentence)    #信息抽取，找到有哪些实体、属性、关系、标签
        templet_cypher_score = self.cypher_match(sentence, info)  #cypher匹配，与我们做的模板做匹配，我们得到每个模板的分数
